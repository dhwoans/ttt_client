    ...
    if (isCurrentUser) {
      return (
        <li className="flex justify-end items-end gap-2">
          ...
          <p className="px-4 py-2 bg-accent text-black rounded-2xl rounded-br-none border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] max-w-xs break-words">
            {message}
          </p>
        </li>
      );
      ...
      return (
        <li className="flex justify-start items-end gap-2">
          <p className="px-4 py-2 bg-white text-black rounded-2xl rounded-bl-none border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] max-w-xs break-words">
            {message}
          </p>
          <small className="text-xs text-gray-600 mb-1">{sender}</small>
        </li>
